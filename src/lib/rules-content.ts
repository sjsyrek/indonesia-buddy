...
export const playerAidSections: PlayerAidSection[] = [
  {
    ...
    content: [
      ...
      'A new era begins when no unclaimed company deeds remain, or only one type is left. Era length varies with no fixed round count.',
  ...
  },
  {
    ...
    content: [
      ...
      'If you cannot pay a cost, take IOUs (negative value at game end). There is no elimination.',
    ],
  },
]
...
export const clarifiedRuleSections: ClarifiedRuleSection[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'Size 2 city: Needs 2 goods of every produced type. Much harder, requiring 2 rice + 2 spice + 2 rubber (etc.).',
      ...
      'Strategy: City growth creates more demand slots, benefiting producers. But the growth condition is demanding, requiring broad supply chains.',
    ],
  },
  {
    id: 'rd-strategy',
    ...
    details: [
      'R&D is FREE to advance, with no monetary cost. You advance one track, one step per year. The cost is purely opportunity cost.',
